            ...
            return (
                ...
                <div>
                    ...
                    <ol className="shelf-list">
                        {this.props.bookList.map((book) => (book.imageLinks && book.imageLinks.smallThumbnail !== undefined &&
                            <li key={book.title} className="shelf-list-item">
                                <img src={book.imageLinks.smallThumbnail} className="shelf-list-img"
                                     alt="books cover"></img>
                                {book.title}
